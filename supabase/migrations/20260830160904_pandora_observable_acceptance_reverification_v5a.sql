...
begin
  ...
  -- This migration is intentionally replay-safe before the canonical static
  -- fallback migration creates convergence v2. The post-fallback migration
  -- below applies the patch once the target exists.
