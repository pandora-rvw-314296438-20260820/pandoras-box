-- Worker B/J: allow bounded long-form Gemini source generation without widening global API timeouts.
-- Credentials remain Vault-only and all existing payload/credential guards stay fail-closed.
