...
alter function public.pandora_accept_intake(uuid,uuid,text,text,text,text,text,text,text)
  set search_path = public, private, auth, extensions, pg_temp;

alter function public.pandora_record_outcome(uuid,text,text,boolean,jsonb,jsonb,numeric,integer,integer,text,jsonb,jsonb,jsonb)
  set search_path = public, private, auth, extensions, pg_temp;
