...
begin
 ...
 values(p_organization_id,p_project_id,p_project_version_id,v_project_resource,'database','supabase',v_env,'shared_isolated',v_external,'ap-southeast-1','ready',jsonb_build_object('projectRef','jcyqixttuebxqqfkjonq','schema',v_schema,'databaseRole',v_role,'authorizationRef',p_authorization_ref,'secretStored',false),v_now,v_now)
