-- Follow-up hardening: only the current exact coordinator check run is authoritative;
-- superseded coordinator instances do not poison the all-checks readback.
