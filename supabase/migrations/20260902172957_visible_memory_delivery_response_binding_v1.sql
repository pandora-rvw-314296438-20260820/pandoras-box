  ...
  set delivery_status = case
      ...
      last_error = case
        ...
        when latest.status_code in (200,202)
          ...
          and latest.error_msg is null
          and latest.payload->>'learning_kind'='visible_creation_evidence_v1'
          then 'VISIBLE_MEMORY_RESPONSE_CONTRACT_INVALID'
