...
begin
  ...
  select * into v_control from public.pandora_activity_controls where job_id=p_job_id and status='requested' order by control_sequence for update skip locked limit 1;
