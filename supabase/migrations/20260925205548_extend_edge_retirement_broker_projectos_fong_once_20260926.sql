...
begin
  ...
  case p_project_ref || ':' || p_slug
    ...
    when 'jcyqixttuebxqqfkjonq:projectos-fong-plan-materializer-once' then
      v_expected_version := 3;
      v_classification_sha := '1b8b00e6e1e20c2433c1591b17219935f262bc43';
    else
