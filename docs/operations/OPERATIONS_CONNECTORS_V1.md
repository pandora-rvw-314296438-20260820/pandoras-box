...
Canonical journal migration: `supabase/migrations/20260925235431_operations_connector_delivery_v1.sql`. Its filename was generated by pinned Supabase CLI 2.116.0 in actual GitHub job 108292791730. SHA-256 `472a9c0a8ddd7e3c86da5ef0604dd078a418d1489bd926466353049069db4223` matches the tested `delivery-schema.sql`. It adds one RLS-enabled private table and two service-only RPCs, seeds nothing and leaves existing core routines unchanged. Source presence is not deployment evidence.
