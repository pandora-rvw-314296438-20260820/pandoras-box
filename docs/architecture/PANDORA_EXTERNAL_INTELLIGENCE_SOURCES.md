...
|---|---|---|---|
| `pandora-rvw-314296438-20260820/awesome-claude-skills` | `be2a406907dbc61b73e6827ded415c96139d13a2` | Skill seed | Root licensing is unresolved. Metadata discovery is allowed; source/instruction materialization is blocked until an explicit approved license is bound. |
