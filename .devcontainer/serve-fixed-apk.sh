...
{"outcome":"passed","sourceSha":"9b682e3593afc2c0f53630d6ec95454d886afbe9","apkSha256":"$ACTUAL_SHA","apkSizeBytes":$ACTUAL_SIZE,"port":9114}
EOF
...
nohup python3 -m http.server 9114 --bind 0.0.0.0 --directory "$SERVE_DIR" >/tmp/pandora-apk-http.log 2>&1 &
sleep 2
gh codespace ports visibility 9114:public -c "$CODESPACE_NAME"
