...
const TOKEN_PATTERNS = [
  ...
  /(?:^|\s)(?:GITHUB_TOKEN|GITHUB_PAT|GITHUB_SUPABASE|VERCEL_TOKEN|SUPABASE_SERVICE_ROLE|SERVICE_ROLE_KEY|GEMINI_API_KEY|MOONSHOT_API_KEY|KIMI_API_KEY|DATABASE_URL)\s*=\s*[^\s]+/gim,
  /sk-[A-Za-z0-9_-]{20,}/g,
