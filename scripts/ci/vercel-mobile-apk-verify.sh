...
REPAIR_SHA=3f8fe73cbc3387b2fa864122df1fbb2cb0358fb3
EXPECTED_APPS_TREE=d4c330b0e5e8d165443b49db0428f4202f29970c
...
flutter build apk --debug \
  --dart-define=PANDORA_SOURCE_REVISION="$REPAIR_SHA" \
...
{
  echo "repair_source_sha=$REPAIR_SHA"
...
printf '<!doctype html><meta charset="utf-8"><title>Pandora Android validation</title><h1>Pandora Android validation</h1><p>Repair source: %s</p><p>Apps tree: %s</p><p>APK SHA-256: %s</p><ul><li><a href="/pandora-debug.apk">APK</a></li><li><a href="/pandora-mobile-artifact-manifest.txt">Manifest</a></li><li><a href="/flutter-analyze.log">Analyze log</a></li><li><a href="/flutter-test.log">Test log</a></li><li><a href="/flutter-build.log">Build log</a></li></ul>' "$REPAIR_SHA" "$EXPECTED_APPS_TREE" "$APK_SHA" > vercel-apk-output/index.html
