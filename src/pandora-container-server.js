...
exports.createPandoraContainerApp = createPandoraContainerApp;
exports.startPandoraContainerServer = startPandoraContainerServer;
...
function createPandoraContainerApp(environment = process.env) {
...
function startPandoraContainerServer(environment = process.env) {
