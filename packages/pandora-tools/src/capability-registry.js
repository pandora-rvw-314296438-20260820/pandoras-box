...
const DEVICE_TOOL_CAPABILITIES = Object.freeze([
  ...
  Object.freeze({
    ...
    kind: "tool",
    scope: "device",
    description: "Read live CPU, RAM, storage, battery, thermal, process and network telemetry when M4-009 is implemented.",
    authority: "public_app",
    ...
    gatewayExecutable: false,
    source: "pandora-device-agent-v1",
    metadata: { deviceCapability: "resource.introspection", implementationOwner: "M4-009", executionOwner: "M3-005" },
  }),
  Object.freeze({
    ...
    kind: "tool",
    scope: "device",
    description: "Run a bounded safe local resource benchmark when M4-009 is implemented.",
    authority: "public_app",
    availability: "implementation_pending",
    risk: RISK_LEVELS.LOW,
    sideEffect: SIDE_EFFECTS.READ,
