...
function renderProjectWorkspace() {
  ...
  return `<div class="owner-screen owner-project-workspace">
    <div class="owner-workspace-header">
      <button type="button" class="owner-workspace-back" data-route="${state.mode === 'professional' ? 'professional-operations' : 'projects'}">${icons.arrow}<span>${state.mode === 'professional' ? 'Operations' : 'Projects'}</span></button>
