...
void main() {
  test('build conversation uses durable lifecycle plus authoritative theatre evidence', () {
  ...
  test('conversation uses durable review state without inferring readiness from candidate identity', () {
    final source = File('lib/features/simple/project_build_conversation.dart')
        .readAsStringSync();
