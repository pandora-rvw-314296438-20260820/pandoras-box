...
void main() {
  ...
  test('project conversation is durable intent plus exact-source ProjectSpec', () {
    final api =
  ...
  test('project changes reuse the same conversation surface', () {
    final iteration =
        File('lib/features/simple/project_iteration_experience.dart')
            .readAsStringSync();
  ...
  test('Simple Mode project conversation does not name infrastructure providers',
      () {
    final source = [
