  ...
  Widget build(BuildContext context) => PandoraSimplePage(
    header: PandoraOwnerHeader(
      ...
      onNotifications: () => Navigator.of(
        context,
      ).push(MaterialPageRoute<void>(builder: (_) => const ApprovalsScreen())),
          ...
          child: Column(
            ...
            children: [
              const Row(
                ...
                children: [
                  PandoraIconBadge(icon: Icons.auto_awesome_rounded, size: 52),
                  SizedBox(width: 14),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        hintText: 'Build an online booking system for my aircon service business.',
                        filled: false,
                        counterText: '',
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  final helper = const Text(
                    ...
                    style: TextStyle(color: Color(0xFF8B8985), fontSize: 12.5),
                  );
                  ...
                  if (constraints.maxWidth < 520) {
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [helper, const SizedBox(height: 12), submit],
                    );
                  }
                  return Row(
                    children: [
...
class _RequestKindCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => PandoraSimpleCard(
    onTap: onTap,
    shadow: false,
    borderColor: selected ? PandoraSimpleColors.red : PandoraSimpleColors.line,
    child: Row(
      children: [
        PandoraIconBadge(
          icon: kind.icon,
        ...
        Container(
          ...
          height: 30,
          decoration: BoxDecoration(
            color: selected ? PandoraSimpleColors.red : PandoraSimpleColors.ink,
