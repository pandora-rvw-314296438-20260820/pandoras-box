...
class _PluginsScreenState extends State<PluginsScreen> {
  ...
  void _openGovernedPluginAction(
    ...
    final prompt = switch (action) {
      _PluginAction.manage =>
        'Manage ${plugin.name}. First verify the live connection, account identity, current scopes and capabilities. Use bounded reads when authorized. Route every consequential change through Pandoraâ€™s governed runtime and show me only the approval or blocker that actually needs me.',
      _PluginAction.connect =>
