...
const IMMUTABLE_MIGRATION_PREFIX = "supabase/migrations/";
...
test("retired control-plane identity is absent from active repository paths and text", () => {
  ...
  for (const file of walk(ROOT)) {
    ...
    if (rel.startsWith(IMMUTABLE_MIGRATION_PREFIX)) continue;
...
test("retirement enforcement migration revokes legacy authority", () => {
  const rel = "supabase/migrations/20260919124500_enforce_pandora_execution_provider_allowlist.sql";
