...
test('active Supabase history preserves the captured 52-file recovery chain and appends governed changes', () => {
  ...
  const governedForwardFiles = new Set([
    ...
    '20260909024500_pandora_publish_separation_reconciliation_v1.sql',
    '20260909030000_pandora_external_experience_write_control_v1.sql',
    '20260909042500_pandora_ruleset_protection_reconciliation_v1.sql',
    ...
    '20260911060500_pandora_chat_pandora_build_theatre_handoff_v1.sql',
    ...
    '20260911164500_pandora_generic_owner_plan_decisions_v1.sql',
    ...
    '20260914050000_pandora_pandora_retirement_v1.sql',
...
'20260916103635_r058_trusted_coordinator_gate.sql',
  ...
  assert.deepEqual(appendedFiles, [
    ...
    '20260821024500_pandora_owner_read_completion.sql',
...
test('database rollback restores the exact prior AAL2 executable body', () => {
  ...
  const rollbackPath = join(
    evidenceRoot,
    'rollback',
    '20260812034825_restore_pandora_approval_aal2.sql',
  );
