...
const supplementalRemoteHistoryReceiptManifest = JSON.parse(
  readFileSync(
    join(
      repositoryRoot,
      'docs',
...
test('active Supabase history preserves the captured 52-file recovery chain and appends governed changes', () => {
  ...
  const governedForwardFiles = new Set([
    ...
    '20260903131045_pandora_visible_creation_canary_control_v1.sql',
    '20260904125641_pandora_memory_edge_release_transport_v1.sql',
    '20260905052500_pandora_static_worker_d_durable_claim_boundary_v1.sql',
    ...
    '20260906034034_pandora_build_theatre_preexecution_truth_v1.sql',
    ...
    '20260906154250_pandora_meta_live_connection_verifier_v1.sql',
    ...
    '20260906185211_pandora_terminal_build_projection_truth_v1.sql',
    '20260906193000_pandora_renderable_preview_transport_v1.sql',
    '20260906202137_pandora_renderable_preview_reverification_convergence_v2.sql',
    '20260906202142_pandora_renderable_preview_reverification_finalizer_v1.sql',
    '20260906203622_pandora_preview_memory_reverification_idempotency_v1.sql',
    ...
    '20260906224812_pandora_owner_api_exact_source_bundle_v1.sql',
    ...
    '20260909024500_projectos_publish_separation_reconciliation_v1.sql',
    ...
    '20260910161000_pandora_theatre_mid_generation_truth_v1.sql',
    '20260911050500_pandora_chat_capability_loop_v1.sql',
    '20260911060500_pandora_chat_projectos_build_theatre_handoff_v1.sql',
    '20260911083500_pandora_universal_chat_runtime_truth_v1.sql',
    '20260911114500_pandora_plugin_runtime_registry_v3.sql',
    '20260911121500_pandora_provider_connection_semantics_v4.sql',
    '20260911131000_pandora_universal_capability_router_v2.sql',
    '20260911135500_pandora_governed_provider_reads_v1.sql',
    '20260911143500_pandora_governed_mutations_v1.sql',
    '20260911161000_pandora_intelligence_thread_management_v1.sql',
    '20260911163000_pandora_intelligence_thread_manage_anon_hardening_v2.sql',
    '20260911164500_projectos_generic_owner_plan_decisions_v1.sql',
    ...
    '20260912182000_pandora_chat_source_contract_v1.sql',
    '20260913040000_pandora_repository_analysis_execution_v1.sql',
    '20260913041000_pandora_owner_project_visibility_v1.sql',
    '20260913043000_pandora_owner_project_visibility_residual_v1.sql',
    '20260913071000_pandora_chat_standing_authority_v8.sql',
    '20260913080649_pandora_chat_project_context_read_fallback_v9.sql',
    '20260913083557_pandora_chat_execution_truth_v10.sql',
    '20260913093000_pandora_chat_direct_audit_workspace_execution_v11.sql',
    '20260913102500_pandora_chat_speech_act_routing_v12.sql',
    '20260913122000_pandora_chat_in_place_execution_v13.sql',
    '20260914050000_pandora_projectos_retirement_v1.sql',
...
'20260916103635_r058_trusted_coordinator_gate.sql',
  ...
  '20260916110444_r058_publication_abort_recovery.sql',
    '20260916124500_r061_direct_communication_activity_v1.sql',
    ...
    '20260919122500_retire_windows_rdp_execution_transport.sql',
    '20260919124500_enforce_pandora_execution_provider_allowlist.sql',
    '20260919171705_phone_local_ai_acceptance_v1.sql',
    '20260919171947_phone_local_ai_acceptance_v1_hardening.sql',
    '20260920022253_phone_local_ai_acceptance_qwen3_4b.sql',
    '20260920062151_phone_local_ai_acceptance_plp_privacy_v2.sql',
    ...
    '20260921093429_pandora_first_party_tracking_v1_fk_hardening.sql',
    '20260921100623_pandora_tracking_owner_scope_and_currency_safe_reporting_v2.sql',
    '20260921100805_pandora_tracking_traffic_daily_dedup_fix_v2.sql',
