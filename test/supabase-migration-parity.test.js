...
test('active Supabase history preserves the captured 52-file recovery chain and appends governed changes', () => {
  ...
  const governedForwardFiles = new Set([
    ...
    '20260917062500_pandora_enterprise_github_read_broker_v1.sql',
    '20260917110110_enterprise_hospitality_overview_v1.sql',
    '20260917110632_pandora_enterprise_business_overview_v1.sql',
    '20260917115426_plp_runtime_schema_bootstrap_v1.sql',
