...
BEGIN
 FOR c IN SELECT * FROM (VALUES
  ('nonmember','20000000-0000-4000-8000-000000000099','2270b266-59da-4c39-bfd9-9f8d08352af0'),
  ...
  ('revoked','20000000-0000-4000-8000-000000000004','2270b266-59da-4c39-bfd9-9f8d08352af0'),
  ('staff','20000000-0000-4000-8000-000000000005','2270b266-59da-4c39-bfd9-9f8d08352af0'),
  ('invited','20000000-0000-4000-8000-000000000006','2270b266-59da-4c39-bfd9-9f8d08352af0'),
  ('suspended','20000000-0000-4000-8000-000000000007','2270b266-59da-4c39-bfd9-9f8d08352af0'),
  ('missing-subject',NULL,'2270b266-59da-4c39-bfd9-9f8d08352af0'),
...
BEGIN
 FOR c IN SELECT * FROM (VALUES
  ('20000000-0000-4000-8000-000000000001','2270b266-59da-4c39-bfd9-9f8d08352af0'),
  ('20000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000002'),
  ('20000000-0000-4000-8000-000000000008','2270b266-59da-4c39-bfd9-9f8d08352af0')
 ) x(uid,org)
 LOOP
  PERFORM set_config('request.jwt.claims',jsonb_build_object('sub',c.uid,'role','authenticated')::text,false);
